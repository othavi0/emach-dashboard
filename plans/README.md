...
| 023 | tests-cpf-cnpj | P2 | S | LOW | tests | none (pairs with 025) | FIXED | TODO |
| 024 | tests-cron-cancel-stale-orders | P2 | S | LOW | tests | none | FIXED | TODO |
...
| 030 | structured-logger | P3 | M | LOW | dx | none | FIXED | TODO |
